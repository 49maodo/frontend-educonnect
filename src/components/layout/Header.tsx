...
export function Header() {
  ...
  return (
    <header className="container mx-auto sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur-sm supports-backdrop-filter:bg-background/60">
      <div className="container mx-auto flex h-16 max-w-(--breakpoint-2xl) items-center">
